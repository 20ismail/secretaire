		...
		<ul class="list-unstyled component m-2">
		  ...
		  <li class="">
			...
			<li>
					...
					<a href="{{ route('salleDispos.index') }}" ><span  <i  class="fa-solid fas fa-school"></i>&nbsp;&nbsp;&nbsp;
					</span>Salle</a>
				...
				<li>
					...
					<li > --}}
						<a href="{{ route('secretaire.module') }}" class="dropdown-toggle" ><span  <i  class="fa-solid fa-book"></i>&nbsp;&nbsp;&nbsp;
						</span>Module</a>
				...
				<li class="">
                    <a href="{{ route('composents.index') }}" class="" id="filierelink"><span <i class="fa-solid fa-graduation-cap"></i>&nbsp;&nbsp;&nbsp;
                    </span>Groupes </a>
                </li>
				<li class="">
						    ...
						    <nav class="navbar p-0">
							   ...
							   <li class="dropdown nav-item">
							     <a class="nav-link" href="#" data-toggle="dropdown">
								  ...
								  <img src="https://img.freepik.com/premium-photo/businessman-portrait-ai-generated-image_268835-5686.jpg" style="width:50px; border-radius:50%;"/>
