  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	  <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1">
		...
		<link rel="stylesheet" href="{{asset('assets\css_secretaire\Filiere.css')}}">
...
<div class="wrapper">
		...
		<ul class="list-unstyled component m-2">
		  ...
		  <li class="">
			<a  href="{{ route('secretaire.index') }}"  ><span  <i  class="fa-solid fa-house"></i>&nbsp;&nbsp;&nbsp;
				...
				<li>
					<!-- Main section: Salle -->
					<a href="{{ route('secretaire.salle') }}" >
						<span><i class="fas fa-school"></i>&nbsp;&nbsp;&nbsp;</span> Salle
					</a>
					<!-- Subsections for Salle -->
				...
				<li>
					...
					<a href="{{ route('secretaire.enseignant') }}" class="dropdown-toggle">
						<span><i class="fas fa-user-tie"></i>&nbsp;&nbsp;&nbsp;</span> Enseignant
					</a>
				...
				<li>
					...
					<a href="{{ route('secretaire.module') }}" class="dropdown-toggle">
						<span><i class="fas fa-book"></i>&nbsp;&nbsp;&nbsp;</span> Module
					</a>
					<!-- Subsections for Modules -->
					<ul class="sub-menu">
						<a href="{{ route('secretaire.dut') }}"><li>DUT</li></a>
						<a href="{{ route('secretaire.lp') }}"><li>LP</li></a>
						<a href="{{ route('secretaire.master') }}"><li>MASTER</li></a>
					</ul>
				</li>
				<li class="">
                    <a href="{{ route('secretaire.filiere') }}" class="" id="filierelink"><span <i class="fa-solid fa-graduation-cap"></i>&nbsp;&nbsp;&nbsp;
                    </span>Filière </a>
                </li>
				<li class="">
   ...
   <!-------sidebar--design- close----------->
    ...
    <div class="boxFilliere">
        <span>Groupe de Cours</span>
        <table>
            <thead>
                <tr>
                    <th>Nomdre de groupes:</th>
                </tr>
            </thead>
            <tbody id="Nombre-group-Cours">
                <tr>
                    <td>
                        <div class="number-bar">
                            <button class="decrement" onclick="decrement('number-grp-Cours')">-</button>
                            <span id="number-grp-Cours">0</span>
                            <button class="increment" onclick="increment('number-grp-Cours')">+</button>
                        </div>
                    </td>
                </tr>
            </tbody>
    ...
    <div class="boxFilliere">
        ...
        <table>
            ...
            <tbody id="Nombre-group-TD">
                <tr>
                    <td>
                        <div class="number-bar">
                            <button class="decrement" onclick="decrement('number-grp-TD')">-</button>
                            <span id="number-grp-TD">0</span>
                            <button class="increment" onclick="increment('number-grp-TD')">+</button>
                        </div>
                    </td>
                </tr>
            </tbody>
    ...
    <div class="boxFilliere">
        ...
        <table>
            ...
            <tbody id="Nombre-group-TP">
                <tr>
                    <td>
                        <div class="number-bar">
                            <button class="decrement" onclick="decrement('number-grp-TP')">-</button>
                            <span id="number-grp-TP">0</span>
                            <button class="increment" onclick="increment('number-grp-TP')">+</button>
                        </div>
                    </td>
                </tr>
            </tbody>
   ...
   <script src="{{asset('assets\js_secretaire\fil.js')}}"></script>
